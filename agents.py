...
- После выполнения напиши краткий отчёт (2-4 предложения максимум): что сделал, детали.
- Можешь добавить одно короткое замечание если что-то важно, но без длинных рассуждений.\
"""
