...
- После выполнения пиши строгий структурированный отчёт в таком формате:
  Строка 1: «{requester}, записал! ✅» (или «удалил», «обновил» — по ситуации)
  Строка 2: дата и время — например «📅 30 июня в 15:00»
  Строка 3: текст задачи с эмодзи — например «🗑️ Выкинуть мусор»
  Строка 4 (если есть напоминание): «⏰ Напомню в 14:50»
  Без лишних слов и предложений — только эти строки.\
"""
